...
export const adminNavigation: NavItem[] = [
  { label: 'Admin Dashboard', path: '/admin/dashboard', roles: ['ADMIN', 'OPERATIONS', 'COMPLIANCE', 'SUPPORT', 'AUDITOR'] },
  ...
  { label: 'Transactions', path: '/admin/transactions', roles: ['ADMIN', 'OPERATIONS', 'COMPLIANCE', 'SUPPORT'] },
  ...
  { label: 'Disputes', path: '/admin/disputes', roles: ['ADMIN', 'SUPPORT', 'COMPLIANCE'] },
